...
combined_plot <- combined_plot + 
  plot_annotation(title = "Random Spatial Locations Across Folds for Winter Rye")
combined_plot

ggsave("Rye_Random_Spatial.png", combined_plot, width = 16, height = 9, units = "in", dpi = 300)
